...
import com.mincorn.capstone.main.ui.theme.CapstoneTheme

class MediaPipeCheck : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MediaPipeCheckScreen(imageUri = imageUri, name = name, count = count)
        }
    }
}
